            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                  ...
                  <?php endif; ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" value="Recover your password" name="forgot-password" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <div class="copyright">
                <p>
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved </i> by <a href="index.php" target="_blank" >Live By Code</a>
                    </p>
            </div>
          </div>
        </div>
