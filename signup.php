        ...
        <div class="container">
          <div class="row align-items-end justify-content-center text-center">
            <div class="col-lg-7">
              ...
              <p>Register to change your career.</p>
            </div>
          </div>
        </div>
      </div> 
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                  ...
                  <?php endif; ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" value="Register" name="signup-btn" class="btn btn-primary btn-lg px-5">
                        </div>
                        <p class="col-12">Already a member? <a href="login.php">Sign In</a></p>
                    </div>
                </div>
            </div>
